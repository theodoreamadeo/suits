      ...
      <div className="max-w-4xl mx-auto">
        {user && (
          <div className="mt-8">
            ...
            <p className="text-gray-600 mb-6 text-center">
              How do you take your Ultimate Personalized Fashion ?
            </p>
            <PreferencesForm />
          </div>
        )}
        ...
        {!user && (
          <div>
            ...
            >
              <h1 className="font-serif text-4xl font-extrabold text-center text-green-900">
                Welcome to SUITS!
              </h1>
              <h2 className="font-serif text-3xl font-extrabold text-center text-green-900">
                ...
                <div className="max-w-7xl mx-auto px-4 py-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    {features.map((feature, index) => (
                      <div
                        key={index}
                        className="relative w-full -z-10 h-72 rounded overflow-hidden shadow-md group"
                      >
                        <Image
                          src={feature.image}
                          alt={feature.title}
              ...
              <section className="w-full py-16 bg-white">
                <div className="max-w-4xl mx-auto px-6 text-center">
                  <h2 className="text-3xl font-serif font-semibold text-green-900 mb-4">
                    Revolutionizing Fashion Industry with AI
                  </h2>
                  <p className="italic font-semibold text-gray-700 mb-6">
                    AI-powered wardrobe assistant that delivers personalized
                    outfit recommendations in the world.
                  </p>
                  <p className="text-gray-800 mb-4">
                    SUITS Pte. Ltd. is transforming fashion retail with AI
                    Wardrobe—an intelligent styling assistant that uses AI to
                    deliver personalized outfit recommendations based on body
                    shape, skin tone, and occasion.
                  </p>
                  <p className="text-gray-800">
                    With a growing demand for AI-driven fashion solutions, SUITS
                    targets busy professionals and style-conscious shoppers
                    through retail partnerships and premium subscriptions.
                  </p>
                </div>
              </section>
            </motion.div>
